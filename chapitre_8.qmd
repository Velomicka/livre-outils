# Outils d'intelligence artificielle {#sec-chap8}
...
source("chapitre_8_file/graphique.R")
ai_evolution
```
...
présenté au chapitre 4 de ce livre.
...
![Menu d'accueil d'Elicit](images/chapitre9_image2.png){#fig-elicit}
...
![Court résumé du sujet](images/chapitre9_image3.png){#fig-results1}

![Suggestions de lectures](images/chapitre9_image4.png){#fig-results2}
...
![Menu principal](images/chapitre9_RR1.png){#fig-rr1}

![Importation manuelle de documents](images/chapitre9_rr2.png){#fig-rr2}

![Présentation de la littérature
similaire](images/chapitre9_RR3.png){#fig-rr3}

![Vue « Timeline » des références](images/chapitre9_rr4.png){#fig-rr4}
...
@sec-chap4 au besoin.], qui contiendra uniquement les ouvrages pour
...
dans le travail de traduction[^chapitre_8-4].

[^chapitre_8-4]: TERMIUM Plus et IATE sont des banques de données
...
L'enjeu écologique que représente l'IA est également à prendre en compte. 
L'intelligence artificielle impacte l'environnement dans la mesure où son 
usage implique : "[des] besoins croissants en calcul et ressources informatiques 
pour collecter les données d’apprentissage, entraîner les modèles d’IA et exécuter 
les algorithmes de prédiction" (Garcia & Schbath, 2025, p.39). Certains travaux portant 
sur l'estimation de l'empreinte carbone de modèles d'apprentissage profond (deep learning) 
ont découvert que l'apprentissage des millions de paramètres de certains modèles 
de langage peut émettre jusqu'à plus de 100 tonnes de dioxyde de carbone 
(Garcia & Schbath, 2025, p.39). Par conséquent, on ne peut négligler la contribution 
actuelle des nouvelles technologies comme les outils d'intelligence artificielle au 
réchauffement global de la planète (van Steenberghe, 2020, p.21). La sensibilisation du monde 
universitaire à une utilisation responsable de l'IA s'avère donc primordiale, compte tenu des 
conséquences environnementales qui en découlent. 

Ainsi, l'avènement de l'IA en recherche apporte des questions et
des réflexions épistémologiques[^chapitre_8-4] et
méthodologiques[^chapitre_8-5] importantes. Ces questions sont
...
[^chapitre_8-4]: L'épistémologie est l'une des branches de la
...
[^chapitre_8-5]: La méthodologie est le champ de la philosophie des
